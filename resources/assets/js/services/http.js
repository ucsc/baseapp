 ...
 */
 ...
 // Vue.http.headers.common['X-CSRF-TOKEN'] = document.head.querySelector('meta[name="csrfToken"]').content;
...
export const http = {
  ...
  // head (method, url, data, successCb = null, errorCb = null) {
  //   method = method.toLowerCase()
  //   axios.head({ url, data, method }).then(successCb).catch(errorCb)
  // },
