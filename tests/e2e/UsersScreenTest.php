...
class UsersScreenTest extends TestCase
{
    public function testUsersScreen()
    {
        ...
        $this->see('form.user-add')
            ...
            ->typeIn('form.user-add input[name="email"]', 'foo@baseapp.net')
            ->typeIn('form.user-add input[name="password"]', 'SecureMuch')
            ->enter()
            ->seeText('foo@baseapp.net', '#usersWrapper');
        ...
        $this->see('form.user-edit')
            ->typeIn('form.user-edit input[name="email"]', 'bar@baseapp.net')
            ->enter()
            ->seeText('bar@baseapp.net', '#usersWrapper');
    }
}
