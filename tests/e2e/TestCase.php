...
abstract class TestCase extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * The default Baseapp URL for E2E (server by `php artisan serve --port=8081`).
     *
     * @var string
     */
     ...
     * @return $this
     */
    protected function login($username = 'baseapp@example.com', $password = 'SoSecureBas3app')
    {
    ...
    {
        $this->login()
            ->seeText('Baseapp Admin', '#userBadge > a.view-profile');
