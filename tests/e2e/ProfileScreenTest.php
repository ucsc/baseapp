...
class ProfileScreenTest extends TestCase
{
    public function testProfileScreen()
    {
        ...
        $this->see('#profileWrapper')
            ...
            ->typeIn('#profileWrapper input[name="email"]', 'bar@baseapp.net')
            ->enter()
            ->see('.alertify-logs')
        ...
        $this->typeIn('#profileWrapper input[name="name"]', 'Baseapp Admin')
            ->typeIn('#profileWrapper input[name="email"]', 'baseapp@example.com')
            ->enter()
            ->see('.alertify-logs')
            ->press(WebDriverKeys::ESCAPE)
            ->notSee('.alertify-logs')
